            ...
            <div class='shop-faq'>
                ...
                <ul>
                    <li><span class="username" style="color: #006600;"><img style='margin-right: 1px; margin-top: 1px;'
                                                                            src='/structure/design/images/icons/regular.png'>Regular Donator</span>
                        - $25 Lifetime Total
                        <ul>
                    ...
                    <li><span class="username" style="color: #990000;"><img style='margin-right: 1px; margin-top: 1px;'
                                                                            src='/structure/design/images/icons/extreme.png'>Extreme Donator</span>
                        - $50 Lifetime Total
                        <ul>
...
<form id="finalize" action="/structure/misc/paypal/paypal.php" method="post" style="display: none;">
    <input type="hidden" id="data" name="data" value="null">
    <input type="hidden" id="giftee" name="giftee" value="">
</form>
<?php $system->displayStruct("footer") ?>
<script>
    $(document).ready(function () {
        ...
        $(".checkout").click(function (e) {
            ...
            if (isCredits) {
                ...
                $.post("/structure/system/ActionHandler.php?action=ModuleAction&name=ShopModule&modAction=checkout", {
                    arr: arr,
                    giftee: $(".giftee").val()
                }, function (data) {
                    if (data == "SUCCESS") {
