...
?>
<script type="text/javascript" src="/structure/design/js/ckeditor/ckeditor.js"></script>
<div class="community">
...
<script>
    $(document).ready(function () {
        ...
        $(document).delegate(".editor > .core > .submit", "click", function () {
            $.post("/structure/system/ActionHandler.php?action=ModuleAction&name=Threads&modAction=" + actionType, {
                html: editor.getData(),
        ...
        $(document).delegate(".post-actions > span.thank-btn, .post-actions > span.edit, .post-actions > span.reply, .post-actions > span.delete", "click", function (e) {
            ...
            if ($(this).hasClass("edit")) {
                ...
                if (window.confirm("Are you sure?")) {
                    $.post("/structure/system/ActionHandler.php?action=ModuleAction&name=Threads&modAction=delete", {
                        tid: <?php echo $_GET['id']?>,
                        pid: pid,
                        bid: <?php echo $_GET['board_id'];?>,
                ...
                $.post("/structure/system/ActionHandler.php?action=ModuleAction&name=Threads&modAction=thanks", {pid: pid}, function (data) {
