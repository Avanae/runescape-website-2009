...
require_once($_SERVER['DOCUMENT_ROOT'] . "/structure/forums/ForumSettings.php");
require_once($_SERVER['DOCUMENT_ROOT'] . "/structure/forums/Thread.php");
require_once($_SERVER['DOCUMENT_ROOT'] . "/structure/forums/Board.php");
require_once($_SERVER['DOCUMENT_ROOT'] . "/structure/forums/Post.php");
