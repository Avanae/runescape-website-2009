...
class AccountModule extends Module
{
    ...
    private static $TABS = array(
        ...
        array("Email Preferences", "EmailPreference", false),
        array("Forum Preferences", "ForumPreference", false),
        array("Message Centre", "MessageCentre", false),
        array("Donator Preferences", "DonatorPreferences", "donator", false),
    ...
    public function load()
    {
        ...
        if (!$this->user->isEmailActivated() || $isEmailUpdate) {
            ...
            if ($isEmailUpdate) {
                $validation = Registry::get("system")->getValidationManager()->getValidation($_GET['code']);
