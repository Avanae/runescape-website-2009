<?php
    define('ICON_DIR', "/structure/design/images/icons/ranks");
    ...
    define("USERBARS", "/structure/design/images/forums/userbars/");
    ...
    class UserTools extends Module {
        ...
        public function getGroupName() {
            ...
            switch ($this->user->getDonatorType()) {
                case 1: return "Extreme Donator";
                case 0: return "Donator";
            }
        ...
        public function getGroupRank() {
            ...
            for ($i = sizeof(self::$RANKS) - 1; $i >= 0; $i--) {
                if ($posts >= self::$RANKS[$i][0]) {
                    return "<img src=\"/structure/design/images/forums/ranks/" . SELF::$RANKS[$i][1] . ".png\">";
                }
            }
        ...
        private function getIcon() {
            ...
            switch ($rights) {
                case 2: return ICON_ADMIN;
                case 1: return ICON_MOD;
            }
        
            switch ($this->user->getDonatorType()) {
                case 1: return ICON_EXT_DONATOR;
                case 0: return ICON_DONATOR;
            }
        }

        public function getUsernameStyle() {
            switch ($this->user->getRights()) {
                case 2: return "color: #ffc600;";
                case 1: return "color: #bebebe;";
            }

            switch ($this->user->getDonatorType()) {
                case 1: return "color: #990000;";
                case 0: return "color: #006600;";
            }
        }
        ...
        public function getGroups() {
            ...
            if ($this->user->getRights() == 0) {
                ...
                switch ($this->user->getDonatorType()) {
                    case 1: $groups .= $this->getGroupLink("ExtremeDonator.png");
                    break;
                    
                    case 0: $groups .= $this->getGroupLink("Donator.png");
                    break;
                }   
            
                switch ($this->user->getIronmanMode()) {
                    case 'STANDARD'; $groups .= $this->getGroupLink("Ironman.png");
                    break; 

                    case 'ULTIMATE'; $groups .= $this->getGroupLink("UltimateIronman.png");
                    break;
                }
        
            } else {
                switch ($this->user->getRights()) {
                    case 2: $groups .= $this->getGroupLink("Administrator.png");
                    break;

                    case 1: $groups .= $this->getGroupLink("Moderator.png");
                    break;
                }
            }
