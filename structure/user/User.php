<?php
require_once($_SERVER['DOCUMENT_ROOT'] . "/structure/user/ContactManager.php");
require_once($_SERVER['DOCUMENT_ROOT'] . "/structure/user/shop/ShopManager.php");
require_once($_SERVER['DOCUMENT_ROOT'] . "/structure/user/notification/NotificationManager.php");
...
class User
{
    ...
    {
        Registry::get("system")->sendEmail($this, $message);
    }
    ...
    public function getProfileImage()
    {
        if ($this->data['profileImage'] == null) {
            return '/structure/design/images/forums/avatars/default-avatar.png';
        }
