        ...
        if ($query) {
            while ($row = $query->fetch(PDO::FETCH_ASSOC)) {
                ...
                if ($type == "NONE") {
                    ...
                    $rights = $row3['rights'];
                    if ($rights == 1) {
                        $icon = "<img src='/structure/design/images/icons/moderator.png'/>";
                    } else if ($donator == 0) {
                        $icon = "<img src='/structure/design/images/icons/regular.png'/>";
                    } else if ($donator == 1) {
                        $icon = "<img src='/structure/design/images/icons/extreme.png'/>";
                    }
                } else if ($type == "standard") {
                    $icon = "<img src='/structure/design/images/icons/standard.png'/>";
                } else if ($type == "ultimate") {
                    $icon = "<img src='/structure/design/images/icons/ultimate.png'/>";
                }
                if ($skill == -1) {
                    echo "
					<ul class='player-row'>
    ...
    public function dumpPersonal()
    {
        ...
        if ($row) {
            ...
            for ($i = 0; $i < 24; $i++) {
                ...
                echo '<div class="personal-skill" id="skill' . $i . '" data-percentage="' . $percentage . '"><img src="/structure/design/images/skills/hd/' . $i . '.png"/><span>' . $level . '</span><div class="hangdown"><div class="exp">' . number_format($xp) . '</div></div></div>';
            }
        }
    }
